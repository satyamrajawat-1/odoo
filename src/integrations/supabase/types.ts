  ...
  public: {
    Tables: {
      ...
      expenses: {
        ...
        Relationships: [
          {
            foreignKeyName: "expenses_approval_sequence_id_fkey"
            columns: ["approval_sequence_id"]
            isOneToOne: false
            referencedRelation: "approval_sequences"
            referencedColumns: ["id"]
          },
          {
    ...
    Enums: {
      ...
      expense_status: "pending" | "approved" | "rejected" | "verification"
    }
    CompositeTypes: {
      [_ in never]: never
    }
